...
//        }
    ...
    private void setPressedStateForTextView(TextView checkedView, boolean pressed) {
        if (checkedView != null && checkedView instanceof TextView) {
            checkedView.setSelected(pressed);
        }
    }
...
//                    relativeLayout1.performClick();
    ...
    private class OnItemClickListener implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            CompoundButton compoundButton = (CompoundButton) relativeLayout.getChildAt(0);
            compoundButton.setChecked(true);
            if (mOnCheckedChangeListener != null) {
                mOnCheckedChangeListener.onCheckedChanged(RadioGroupPlus.this, mCheckedId);
            }
        }
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            ...
            if (parent == RadioGroupPlus.this && child instanceof TextView) {
                int id = child.getId();
                // generates an id if it's missing
                if (id == View.NO_ID) {
                    id = View.generateViewId();
