...
public class TopRightMenu {
    ...
    private void init() {
        content = LayoutInflater.from(mContext).inflate(R.layout.toolbar_popup_menu, null);
        mRecyclerView = (RecyclerView) content.findViewById(R.id.trm_recyclerView);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(mContext, LinearLayoutManager.VERTICAL, false));
        mRecyclerView.addItemDecoration(new DividerDecoration(mContext,LinearLayoutManager.VERTICAL,2,R.color.text_colorPrimary,true));
    ...
    public interface OnMenuItemClickListener {
        void onMenuItemClick(int position, int itemId);
    }
}
