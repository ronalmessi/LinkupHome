...
import kotlinx.android.synthetic.main.close_timer_setting_fragment.*
import java.util.*
 ...
 */
open class CloseTimerSettingFragment : BaseFragment(){
            ...
            mViewModel.mCurrentLocalState.observe(this, Observer<Resource<LocalState>> {
                if (it.status == Status.SUCCESS) {
                    it.data?.let {
                        ...
                        calendar.time = Date(it.closeTimer)
                        ...
                        switch_button_timer.isChecked = it.closeTimerOn==1
                    }
                }
            })
        }
