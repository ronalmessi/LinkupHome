...
class AppConfig {
    ...
    companion object {
        val DEVICE_MODEL_NAME = arrayListOf("C3", "R2", "A2", "N1", "M1", "V1", "S1", "S2", "T1")
        val DEVICE_NAME = arrayListOf(R.string.lamp_c3, R.string.lamp_r2, R.string.lamp_a2, R.string.lamp_n1, R.string.lamp_m1, R.string.lamp_v1, R.string.lamp_s1, R.string.lamp_s2, R.string.lamp_t1)
        val DEVICE_ICON = arrayListOf(R.mipmap.ic_lamp_c3, R.mipmap.ic_lamp_r2_a2, R.mipmap.ic_lamp_r2_a2, R.mipmap.ic_lamp_n1, R.mipmap.ic_lamp_m1, R.mipmap.ic_lamp_v1, R.mipmap.ic_lamp_s1_s2, R.mipmap.ic_lamp_s1_s2,R.mipmap.ic_lamp_s1_s2)
