...
class AppConfig {
    ...
    companion object {
        ...
        val DEVICE_NAME = arrayListOf(R.string.lamp_c3, R.string.lamp_r2, R.string.lamp_a2, R.string.lamp_n1, R.string.lamp_m1, R.string.lamp_v1, R.string.lamp_s1, R.string.lamp_s2, R.string.lamp_t1, R.string.lamp_v1)
