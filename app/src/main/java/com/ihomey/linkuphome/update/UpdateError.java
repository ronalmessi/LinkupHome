...
public class UpdateError extends Throwable {
    ...
    static {
        ...
        messages.append(DOWNLOAD_UNKNOWN, "下载失败");
        messages.append(DOWNLOAD_CANCELLED, "下载失败");
        messages.append(DOWNLOAD_DISK_NO_SPACE, "下载失败");
        messages.append(DOWNLOAD_DISK_IO, "下载失败");
        messages.append(DOWNLOAD_NETWORK_IO, "下载失败");
        messages.append(DOWNLOAD_NETWORK_BLOCKED, "下载失败");
        messages.append(DOWNLOAD_NETWORK_TIMEOUT, "下载失败");
        messages.append(DOWNLOAD_HTTP_STATUS, "下载失败");
        messages.append(DOWNLOAD_INCOMPLETE, "下载失败");
        messages.append(DOWNLOAD_VERIFY, "下载失败");
    }
}
