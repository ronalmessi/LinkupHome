 ...
 */
class MiniOutdoorControlFragment : BaseControlFragment() {
    private lateinit var mViewDataBinding: FragmentControlRgbLedBinding

    fun newInstance(): MiniOutdoorControlFragment {
        return MiniOutdoorControlFragment()
    }
    ...
    override fun updateViewData(controlDevice: ControlDevice?) {
        if (controlDevice != null) {
            ...
            mViewDataBinding.deviceSeekBarBrightness.max=81
