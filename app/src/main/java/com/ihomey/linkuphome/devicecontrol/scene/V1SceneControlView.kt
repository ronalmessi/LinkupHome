...
class V1SceneControlView(val layoutId:Int, val context:Context): BaseSceneControlView(context,layoutId) {
    ...
    override fun bindTo(localState: LocalState?) {
        ...
        when (localState?.sceneMode) {
            0 -> radioGroupPlus.check(R.id.rb_scene_flow)
            1 -> radioGroupPlus.check(R.id.rb_scene_star)
            2 -> radioGroupPlus.check(R.id.rb_scene_rainbow)
            3 -> radioGroupPlus.check(R.id.rb_scene_surf)
            4 -> radioGroupPlus.check(R.id.rb_scene_seek)
        }
