...
class AddedLampCategoryAdapter(layoutId: Int) : BaseQuickAdapter<LampCategory, BaseViewHolder>(layoutId) {
    ...
    private val icons = arrayListOf(R.mipmap.lamp_icon_lawn, R.mipmap.lamp_icon_rgb, R.mipmap.lamp_icon_warm_cold, R.mipmap.lamp_icon_led, R.mipmap.lamp_icon_bed)
